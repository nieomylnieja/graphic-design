...
pgn::GameCollection::insert(pgn::GameCollection::iterator position, const pgn::Game &game) {
    hdata->games.insert(position.hdata->it, game);
    return position;
}

void pgn::GameCollection::insert(pgn::GameCollection::iterator position, pgn::GameCollection::iterator first,
                                 pgn::GameCollection::iterator last) {
...
pgn::GameCollection::iterator
pgn::GameCollection::erase(pgn::GameCollection::iterator first, pgn::GameCollection::iterator last) {
