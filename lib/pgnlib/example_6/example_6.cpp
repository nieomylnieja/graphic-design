...
int main(int argc, char *argv[]) {
    ...
    try {
        ...
        std::cout << "King moves processed           : " << piece_move_counters["king"] << " (" << percentage << "%)"
                  << std::endl;

        percentage = 100.0 / ply_count * piece_move_counters["queen"];
        std::cout << "Queen moves processed          : " << piece_move_counters["queen"] << " (" << percentage << "%)"
                  << std::endl;

        percentage = 100.0 / ply_count * piece_move_counters["rook"];
        std::cout << "Rook moves processed           : " << piece_move_counters["rook"] << " (" << percentage << "%)"
                  << std::endl;

        percentage = 100.0 / ply_count * piece_move_counters["bishop"];
        std::cout << "Bishop moves processed         : " << piece_move_counters["bishop"] << " (" << percentage << "%)"
                  << std::endl;

        percentage = 100.0 / ply_count * piece_move_counters["knight"];
        std::cout << "Knight moves processed         : " << piece_move_counters["knight"] << " (" << percentage << "%)"
                  << std::endl;

        percentage = 100.0 / ply_count * piece_move_counters["pawn"];
        std::cout << "Pawn moves processed           : " << piece_move_counters["pawn"] << " (" << percentage << "%)"
                  << std::endl;
        std::cout << std::endl;
    }
